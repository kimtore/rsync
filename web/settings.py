...
# Enable CORS from anywhere and only to /api/
...
try:
    ...
    raise Exception('Cannot find a local_settings.py file. Please create the file, see local_settings.py.example for a template.')
